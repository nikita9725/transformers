...
### Анализ ошибок
- Всего примеров: 600, ошибок: 39 (точность 93.50%)
- False Positives: 17 — модель ошибочно считает негативные отзывы позитивными
- False Negatives: 22 — модель пропускает позитивные отзывы (неявный позитив, идиомы)
