...
### Анализ ошибок
- Всего примеров: 600, ошибок: 38 (точность 93.67%)
- False Positives: 20 — модель ошибочно считает негативные отзывы позитивными
- False Negatives: 18 — модель пропускает позитивные отзывы (неявный позитив, идиомы)
