...
# Для обучения используется заданная в проекте длина последовательности — 128 токенов.
# Большинство предложений датасета короче, поэтому оставшаяся часть заполняется паддингом.
